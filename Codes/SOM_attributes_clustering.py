...
out_file_path = '../Results/Centroid_Clustering_Result/final_AttributeCluster_centroid_' + str(x * y) + '_itr' + str(
    iteration) + '.csv'
...
out_file_path_test = '../Results/Centroid_Clustering_Result/final_CentroidDistance_20_' + str(x * y) + '_itr' + str(
    iteration) + '.csv'
