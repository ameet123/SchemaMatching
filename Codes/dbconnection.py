...
run_type = "test"
print "Running test -> Matching pickle files to be created..."
...
for i in range(0, len(modifiers_column)):
    if modifiers_column[i][0] == 'PRIMARY KEY' or modifiers_column[i][0] == 'FOREIGN KEY' or modifiers_column[i][
        0] == 'UNIQUE':
        constraint_column.append(modifiers_column[i])

print "Constraint columns ---"
